            ...
            <Tabs defaultValue="descripcion" className="w-full">
              ...
              <TabsContent value="descripcion" className="py-4">
                ...
                <div className="mt-8 p-4 border border-border rounded-lg">
                  <h3 className="text-lg font-semibold mb-3">Conectar con IAs</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    Puedes conectar tus propias claves de API para utilizar diferentes modelos de IA con este y otros recursos.
                    Las claves se almacenan localmente en tu navegador y nunca se envían a nuestros servidores.
                  </p>
                  
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    <div className="p-4 border border-border rounded-md flex flex-col relative overflow-hidden shadow-sm">
                      <div className="absolute top-0 right-0 bg-green-100 dark:bg-green-900 px-2 py-0.5 text-xs text-green-700 dark:text-green-300 rounded-bl-md">
                        Gratuito
                      </div>
                      <div className="font-medium text-lg mb-2 flex items-center">
                        <svg viewBox="0 0 24 24" width="24" height="24" className="mr-2">
                          <path d="M1 12C1 5.9 5.9 1 12 1c6.1 0 11 4.9 11 11 0 1.5-.3 3-.8 4.4l-2.8-.9c.4-1.1.6-2.3.6-3.5 0-4.4-3.6-8-8-8s-8 3.6-8 8 3.6 8 8 8c1.5 0 2.9-.4 4.1-1.1l1.5 2.4c-1.7.9-3.6 1.7-5.6 1.7-6.1 0-11-4.9-11-11z" fill="#8e55d1" />
                          <path d="M15 9.1V3h2v4.4c2.8 1 4.2 4.1 3.2 6.9-1 2.9-4.1 4.5-7.1 3.5-3-1-4.6-4.1-3.6-7 .7-2.1 2.7-3.7 5.5-3.7z" fill="#b592e5" />
                        </svg>
                        Google Gemini
                      </div>
                      ...
                      <div className="space-y-2 mb-4">
                        <label className="text-xs font-medium">Tu API Key</label>
                        <div className="flex">
                          <input 
                            type="password" 
                            placeholder="Ingresa tu clave de API de Gemini" 
                            className="flex-1 px-3 py-1.5 text-sm border border-input rounded-l-md focus:outline-none focus:ring-1 focus:ring-primary"
                          />
                      ...
                      <div className="mt-auto pt-2 border-t border-border">
                        ...
                        >
                          ¿No tienes una clave? Obtén una gratis aquí →
                        </a>
                      </div>
                    </div>
                    
                    <div className="p-4 border border-border rounded-md flex flex-col relative overflow-hidden shadow-sm">
                      <div className="absolute top-0 right-0 bg-amber-100 dark:bg-amber-900 px-2 py-0.5 text-xs text-amber-700 dark:text-amber-300 rounded-bl-md">
                        Créditos gratis
                      </div>
                      <div className="font-medium text-lg mb-2 flex items-center">
                        <svg viewBox="0 0 24 24" width="24" height="24" className="mr-2">
                          <path d="M10.5 18.5c0-3 3-2.5 3-6.5a3 3 0 10-6 0c0 4 3 3.5 3 6.5z" fill="#10a37f" />
                          <path d="M21.66 12a9.65 9.65 0 01-1.9 5.83 9.66 9.66 0 01-17.5-5.65A9.67 9.67 0 0112 2.35a9.67 9.67 0 019.66 9.66z" stroke="#10a37f" strokeWidth="2" fill="none" />
                        </svg>
                        OpenAI / ChatGPT
                      </div>
                      <p className="text-xs text-muted-foreground mb-3">
                        Modelos disponibles: GPT-4o, GPT-3.5-Turbo, DALL-E
                      </p>
                      <div className="space-y-2 mb-4">
                        <label className="text-xs font-medium">Tu API Key</label>
                        <div className="flex">
                      ...
                      <div className="mt-auto pt-2 border-t border-border">
                        <a 
                          ...
                          className="text-xs text-primary hover:underline"
                        >
                          ¿No tienes una clave? Obtén una aquí →
                        </a>
                      </div>
                    </div>
                    ...
                    <div className="p-4 border border-border rounded-md flex flex-col relative overflow-hidden shadow-sm">
                      <div className="font-medium text-lg mb-2 flex items-center">
                        <svg viewBox="0 0 24 24" width="24" height="24" className="mr-2">
                          <circle cx="12" cy="12" r="11" fill="#050A0E" />
                          <path d="M7 11.5C7 9.01472 9.01472 7 11.5 7H12.5C14.9853 7 17 9.01472 17 11.5V16H12.5C9.46243 16 7 13.5376 7 10.5V11.5Z" fill="#FF3800" />
                        </svg>
                        xAI Grok
                      </div>
                      <p className="text-xs text-muted-foreground mb-3">
                        Modelos disponibles: Grok-2, Grok-Vision
                      </p>
                      <div className="space-y-2 mb-4">
                        <label className="text-xs font-medium">Tu API Key</label>
                        <div className="flex">
                          <input 
                            type="password" 
                            placeholder="Ingresa tu clave de API de xAI" 
                            className="flex-1 px-3 py-1.5 text-sm border border-input rounded-l-md focus:outline-none focus:ring-1 focus:ring-primary"
                          />
                          <Button size="sm" variant="default" className="rounded-l-none">
                            Guardar
